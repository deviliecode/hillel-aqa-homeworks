...
# ВИРІШЕННЯ:
# Додаю свій запис на початок списку
...
if people_records[6][2] >= 30 and people_records[10][2] >= 30 and people_records[13][2] >= 30:
    print(f"Люди з індексом 6 {people_records[6][0]}, 10 {people_records[10][0]}, 13 {people_records[13][0]} мають більше ніж 30 років")
else:
    print(f"Не всі люди з індексом 6, 10, 13 маюьть 30 або більше років")
