...
# Створюю цикл який додає значення з таплу(який є значенням ключа в словнику) у потрібному мені порядку до мого нового списку
for key, value in car_data.items():

  if value[1] >= year and value[2] >= engine and value[4] <= price:
    cars_from_search_criteria.append([value[4], key, value[1], value[2]])
